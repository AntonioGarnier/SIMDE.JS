...
import SettingsGroup from '../Components/SettingsProblem'
    ...
    return (
        <ControlPanel>
            <Switch>
                ...
                <Route sensitive path="/problem-list" component={ProblemList} />
                <Route sensitive path="/instance-list" render={() => <h1>Instance List</h1>} />
