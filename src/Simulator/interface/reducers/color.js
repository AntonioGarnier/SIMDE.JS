...
function colorFunctionalUnit(functionalUnit, instructiondId, color) {
    const newFunctionalUnit = Object.assign({}, functionalUnit);
    newFunctionalUnit.content = newFunctionalUnit.content.map(ce => ce.map(cee => {
