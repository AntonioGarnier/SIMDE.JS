...
export const REMOVE_GENERAL_REGISTERS_INTERVAL = 'REMOVE_GENERAL_REGISTERS_INTERVAL';
export const ADD_FLOATING_REGISTERS_INTERVAL = 'ADD_FLOATING_REGISTERS_INTERVAL';
export const REMOVE_FLOATING_REGISTERS_INTERVAL = 'REMOVE_FLOATING_REGISTERS_INTERVAL';
