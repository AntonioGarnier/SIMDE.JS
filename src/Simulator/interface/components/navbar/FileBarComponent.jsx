...
class FileBarComponent extends React.Component {
    ...
    render() {
        return (<div className='smd-filebar'>
                    <DropdownButton title={t('fileBar.file.name')} key={'dropdown-load'} id={'dropdown-load'} noCaret>
                        ...
                        <MenuItem eventKey="2" componentClass={Link} href="/login" to="/login" >Login</MenuItem>
                    </DropdownButton>
            ...
            this.props.actions.viewBasicBlocks(this.color);
                    ...
                    <DropdownButton title={t('fileBar.config.name')} key={'dropdown-options'} id={'dropdown-options'} noCaret>
                    ...
                    <DropdownButton title={t('fileBar.experimentation.name')} key={'dropdown-experimentation'} id={'dropdown-experimentation'} noCaret>
                        <MenuItem eventKey="2" onClick={() => { this.props.actions.toggleBatchModal(true); }}>
                            {t('fileBar.experimentation.batch')}
                        </MenuItem>
                    </DropdownButton>
                    <DropdownButton title={t('fileBar.help.name')} key={'dropdown-help'} id={'dropdown-help'} noCaret>
