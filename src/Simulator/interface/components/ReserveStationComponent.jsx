...
export function ReserveStationComponent(props) {
    return (<div className="smd-reserve_station panel panel-default">
            ...
            <div className="smd-reserve_station-body panel-body">
                <div className="smd-table">
                    ...
                    <div className="smd-table-body">
                        {props.data &&
        props.data.map((row, i) => (<div className="smd-table_row" title={row.instruction.value} key={`${props.title + i}`} style={{
