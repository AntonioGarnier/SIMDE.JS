...
class LoadModalComponent extends React.Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.handleInputFileChange = (e, results) => {
            results.forEach(result => {
                const [e] = result;
                let a = document.getElementById('codeInput');
    ...
    render() {
        return (<Modal className="smd-load_modal" show={this.props.isLoadModalOpen} onHide={this.close}>
            ...
            <Modal.Body>
                <textarea id='codeInput' defaultValue={DEFAULT_CODE}>
                </textarea>
