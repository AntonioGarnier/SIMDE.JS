...
import { clearBatchResults } from '../../actions/modals';
...
class BatchResultsModalComponent extends React.Component {
    ...
    render() {
        return (<Modal show={this.props.isBatchResultsModalOpen} onHide={this.close}>
...
export default translate('common', { wait: true })(connect(mapStateToProps, mapDispatchToProps)(BatchResultsModalComponent));
