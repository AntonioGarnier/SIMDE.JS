...
class RegisterComponent extends React.Component {
    ...
    render() {
        ...
        return (<div className='smd-register'>
                        {<IntervalModalComponent title={this.props.title} onAccept={this.props.addInterval} max={this.props.max} open={this.state.isAddModalOpen} close={this.closeAddInterval}/>}
                        {<IntervalModalComponent title={this.props.title} onAccept={this.props.removeInterval} max={this.props.max} open={this.state.isRemoveModalOpen} close={this.closeRemoveInterval}/>}
                        <div className='panel panel-default'>
                              <div className='panel-heading'>{t(this.props.title)}</div>
                              <div className='panel-body'>
                                    <div className='smd-table'>
                                    {renderCondition && this.props.visibleRange.map(index => <div className='smd-table_row' key={`${this.props.title + index}`}>
