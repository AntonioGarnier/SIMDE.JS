...
class GeneralTabComponent extends React.Component {
    ...
    render() {
        return (<div className="smd-general_tab">
                    ...
                    <div className="smd-general_tab-simulation_left">
                        ...
                        <div className="smd-general_tab-simulation_mappers">
                            <div className="smd-general_tab-simulation_register_mapper">
                                <ROBMapperComponent title="ROB<->GPR" data={this.props.ROBGpr.data} visibleRange={this.props.ROBGpr.visibleRangeValues} addInterval={this.props.actions.addRobGprInterval} removeInterval={this.props.actions.removeRobGprInterval}/>
                            </div>
                            <div className="smd-general_tab-simulation_register_mapper">
                                <ROBMapperComponent title="ROB<->FPR" data={this.props.ROBFpr.data} visibleRange={this.props.ROBFpr.visibleRangeValues} addInterval={this.props.actions.addRobFprInterval} removeInterval={this.props.actions.removeRobFprInterval}/>
                            </div>
                            <div className="smd-general_tab-simulation_register_mapper">
